...
class RingBufferDescriptor(BaseModel):
    """Information required to attach to a shared ring buffer."""

    name: str
    reader_count_name: str
    data_lock_ids: Tuple[str, ...]
    reader_gate_ids: Tuple[str, ...]
    reader_count_lock_ids: Tuple[str, ...]
    slots: int
