"""
Fermat spiral scan implementation for two-motor area scans.
    ...
    def __init__(
        ...
        *,
        ...
        spiral_type: Annotated[
            float,
            ScanArgument(
                display_name="Spiral Type",
                description="Angular offset in radians that determines the shape of the spiral",
                ge=0,
                le=2,
                units=Units.rad,
            ),
