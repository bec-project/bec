"""
Hexagonal scan implementation for two-motor area scans on a hexagonal lattice.
...
class HexagonalScan(ScanBase):
    ...
    def __init__(
        ...
        start_motor1: Annotated[
            float, ScanArgument(display_name="Start Position", reference_units="motor1")
        ],
        stop_motor1: Annotated[
            float, ScanArgument(display_name="Stop Position", reference_units="motor1")
        ],
        step_motor1: Annotated[
            float, ScanArgument(display_name="Step Size", reference_units="motor1", gt=0)
        ],
        motor2: DeviceBase,
        start_motor2: Annotated[
            float, ScanArgument(display_name="Start Position", reference_units="motor2")
        ],
        ...
        **kwargs,
        ...
        Args:
            ...
            start_motor1 (float): start position of the first motor
            stop_motor1 (float): stop position of the first motor
            step_motor1 (float): step size of the first motor
        ...
        Examples:
            >>> scans.hexagonal_scan(dev.motor1, -5, 5, 1, dev.motor2, -4, 4, 1, exp_time=0.1, relative=True)
        """
