"""Status objects for tracking scan device instructions."""
...
class ScanStatus:
    ...
    def __init__(
        ...
        self._sub_status_objects: list[ScanStatus] = []
        self._done = done
    ...
    def __repr__(self):
        ...
        if self.message:
            ...
            return f"ScanStatus({name}{self._device_instr_id}, action={instr}, devices={devices}, done={self._done})"
        return f"ScanStatus({name}{self._device_instr_id}, done={self._done})"
