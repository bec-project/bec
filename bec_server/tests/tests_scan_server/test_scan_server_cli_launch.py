...
def test_main():
    with (
        ...
        mock.patch("bec_server.scan_server.scan_server.ScanServer") as mock_scan_server,
        mock.patch("bec_server.scan_server.cli.launch.threading.Event") as mock_event,
    ):
        main()
