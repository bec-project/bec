...
def test_atlas_connector_load_env(SciHubMock, connected_atlas_connector):
    ...
    with (
        ...
        mock.patch("bec_server.scihub.atlas.atlas_connector.dotenv_values") as mock_dotenv_values,
        mock.patch.object(atlas_connector, "_update_config") as mock_update_config,
    ):
