...
def test_main_start():
    with (
        mock.patch("bec_server.bec_server_utils.launch.ServiceHandler") as mock_service_handler,
        mock.patch("bec_server.bec_server_utils.launch.argparse") as mock_argparse,
    ):
