...
class MessageEndpoints:
    ...
    def login_info():
        ...
        return EndpointInfo(
            endpoint=endpoint, message_type=messages.LoginInfoMessage, message_op=MessageOp.SET
        )
    ...
    def acl_accounts():
        ...
        return EndpointInfo(
            endpoint=endpoint, message_type=messages.ACLAccountsMessage, message_op=MessageOp.SET
        )
