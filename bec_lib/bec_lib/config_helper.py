...
class ConfigHelper:
    ...
    def _merge_conflicts_with_user_input(
        self, config: dict, conflicts: dict, validate: bool = True
    ) -> None:
        """
        ...
        Args:
            ...
            validate (bool): Whether to validate newly loaded config. Defaults to True.
        """
        console = Console()
