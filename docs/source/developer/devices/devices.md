...
- the [Device Server](developer.devices.bec_device_server) is the central hub where BEC manages all devices
- the [Ophyd library](developer.ophyd) provides a hardware abstraction layer for devices
